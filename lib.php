...
/**
 * This file contains main class for the course format mypdchat
 *
 * @since     Moodle 2.7
...
require_once($CFG->dirroot . '/course/format/mypdchat/pages/post_form.php');

/**
 * Main class for the mypdchat course format
 *
 * @package    format_mypdchat
 * @copyright  2014 Andreas Wagner, Synergy Learning
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_mypdchat extends format_topics {
     ...
     *
     * mypdchat format uses the following options:
     * - coursedisplay
     * - hiddensections
     *
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($courseformatoptions === false) {
            $courseconfig = get_config('format_mypdchat');
        ...
        if ($foreditform && !isset($courseformatoptions['enablenotification']['label'])) {
            ...
            $courseformatoptionsedit = array(
                'enablenotification' => array(
                    'label' => new lang_string('enablenotification', 'format_mypdchat'),
                    'element_type' => 'selectyesno',
                    'help' => 'enablenotification',
                    'help_component' => 'format_mypdchat'
                ),
                'enablelikes' => array(
                    'label' => new lang_string('enablelikes', 'format_mypdchat'),
                    'element_type' => 'selectyesno',
                    'help' => 'enablelikes',
                    'help_component' => 'format_mypdchat'
                ),
                'enablestudentupload' => array(
                    'label' => new lang_string('enablestudentupload', 'format_mypdchat'),
                    'element_type' => 'selectyesno',
                    'help' => 'enablestudentupload',
                    'help_component' => 'format_mypdchat',
                ),
                'tlnumposts' => array(
                    'label' => new lang_string('tlnumposts', 'format_mypdchat'),
                    'element_type' => 'select',
                    'element_attributes' => array($nums),
                ),
                'tlnumcomments' => array(
                    'label' => new lang_string('tlnumcomments', 'format_mypdchat'),
                    'element_type' => 'select',
                    'element_attributes' => array($nums),
                ),
                'tlnumreplies' => array(
                    'label' => new lang_string('tlnumreplies', 'format_mypdchat'),
                    'element_type' => 'select',
                    'element_attributes' => array($nums),
                ),
                'deleteafterunenrol' => array(
                    'label' => new lang_string('deleteafterunenrol', 'format_mypdchat'),
                    'element_type' => 'selectyesno',
                    'help' => 'deleteafterunenrol',
                    'help_component' => 'format_mypdchat'
                ),
                'deletemodspermanently' => array(
                    'label' => new lang_string('deletemodspermanently', 'format_mypdchat'),
                    'element_type' => 'selectyesno',
