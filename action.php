...
$PAGE->set_url(new moodle_url('/course/format/mypdchat/action.php', array('id' => $courseid)));
...
switch ($action) {
    ...
    case 'deletepost' :
        ...
        $formatsociallwallposts = \format_mypdchat\local\posts::instance($course->id);
    ...
    case 'likepost' :
        ...
        \format_mypdchat\local\action_handler::like_post($course);
        redirect($redirecturl);
        break;
    ...
    case 'lockpost' :
        ...
        \format_mypdchat\local\action_handler::lock_post($course);
        redirect($redirecturl);
        break;

    case 'postcomment' :

        \format_mypdchat\local\action_handler::post_comment($course);
        redirect($redirecturl);
        break;

    case 'deletecomment' :

        \format_mypdchat\local\action_handler::delete_comment();
        redirect($redirecturl);
        break;
